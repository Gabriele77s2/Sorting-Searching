/* Heap Sort
It is a comparison based sorting technique based on Binary Heap.
...
The first is called as max heap and the second is called min-heap.
The heap can be represented by a binary tree or array.

Why array based representation for Binary Heap?
Since a Binary Heap is a Complete Binary Tree, it can be represented as an array and the array-based representation is space-efficient.
